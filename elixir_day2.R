...
head(fisher_go_zhang[,c(3,4,6,9)])
...
head(fisher_kegg_zhang[,c(3,4,6,9)])
...
head(fisher_biocarta_zhang[,c(3,4,6,9)])
...
head(fisher_reactome_zhang[,c(3,4,6,9)])
...
head(fisher_positional_zhang[,c(3,4,6,9)])
...
head(fisher_go_moran[,c(3,4,6,9)])
...
head(fisher_kegg_moran[,c(3,4,6,9)])
...
head(fisher_reactome_moran[,c(3,4,6,9)])
...
head(fisher_positional_moran[,c(3,4,6,9)])
...
gsea_positional_zhang = GSEA(ranked_genelst, exponent = 1, nPerm = 1000, minGSSize = 10,
                             ...
                             TERM2NAME = NA, verbose = TRUE, seed = FALSE, by = "fgsea")
head(gsea_positional_zhang[,3:7])
